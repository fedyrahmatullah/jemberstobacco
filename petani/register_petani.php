	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100 p-l-110 p-r-110 p-t-62 p-b-33">
				<form enctype="multipart/form-data" action="cek_register.php" method="post" class="login100-form flex-sb flex-w">
          ...
          <div class="wrap-input100">
            <input class="input100" type="text" name="class" required>
            <span class="focus-input100"></span>
          </div>
					<div class="p-t-31 p-b-9">
						<span class="txt1">
