...
@font-face {
  ...
  src: url('assets/fonts/glyphicons/glyphicons-halflings-regular.eot?#iefix') format('embedded-opentype'), url('assets/fonts/glyphicons/glyphicons-halflings-regular.woff') format('woff'), url('assets/fonts/glyphicons/glyphicons-halflings-regular.ttf') format('truetype'), url('assets/fonts/glyphicons/glyphicons-halflings-regular.svg#glyphicons-halflingsregular') format('svg');
}
...
<div class="navbar-collapse collapse" id="navbar-collapse1">
               <ul class="nav navbar-nav">
                ...
                <ul class="nav navbar-nav navbar-right">
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-user"></i> raya jaya<strong class="caret"></strong></a>                  
