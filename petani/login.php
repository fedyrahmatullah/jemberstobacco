      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12" id="header-page">
           <center><h1><span> Jember's Tobacco </span></h1></center>
          </div>
              ...
              <div class="konten">
                ...
                <div class="row">
                  <div class="col-md-12">
                    ...
                    <div class="login-wrap" style="background-image: url(../img/tobacco.png);">
                          ...
                          <div class="login-form">
                            <div class="sign-in-htm">
                              ...
                              <div class="w-full text-center p-t-55">
                                ...
                                <a href="register_petani.php" class="txt2 bo1">
                                  <b>Register</b>
                                </a>
