      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12" id="header-page">
            <h1><span> Data Informasi </span></h1>
          </div>
                ...
                <div class="row">
                  <div class="col-md-12">
                    ...
                    <div class="col-md-6 thumbnail dosen">
                      ...
                      <tr><td><center><img src="img/<?php echo $data ['gambar']; ?>" title="<?php echo $data ['gambar']; ?>" alt="<?php echo $data ['gambar']; ?>" height="130" width="130"></center></td> <td> <?php include "kunjungan.php";?><br> 
                        <p><?php echo substr ($data['isi'],0,250);?> ...</p><p align="right"><a href="isi_postingan.php?id_postingan=<?php echo $data ['id_postingan']; ?>"><button class="btn btn-primary" type="submit">Baca Selengkapnya</button></a></p></td></tr>
                    </div>
                    <?php
                    $i++;
                    $count++;
