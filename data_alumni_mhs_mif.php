...
//        pagination config start
                ...
                $sql = "SELECT * FROM mhs WHERE ((nim LIKE '%$q%') OR (nama LIKE '%$q%') OR (angkatan LIKE '%$q%')) AND prodi='Manajemen Informatika' ORDER BY th_lulus DESC"; // query silahkan disesuaikan
