                ...
                <div class="row">
                  <div class="col-md-12">
                    ...
                    <div class="col-md-6 thumbnail dosen">
                      ...
                      <tr><td><center><img src="img/<?php echo $data ['gambar']; ?>" title="<?php echo $data ['gambar']; ?>" alt="<?php echo $data ['gambar']; ?>" height="130" width="130"></center></td><td><?php include "kunjungan.php";
